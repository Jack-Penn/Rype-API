...
const { MultiFormatReader, BarcodeFormat, DecodeHintType } = require('@zxing/library/esm5');
...
async function scanBarcode(imageData) {
  ...
  const luminanceSource = reader.createLuminanceSource(imageData, width, height);
